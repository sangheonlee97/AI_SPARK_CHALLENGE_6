...
RANDOM_STATE = 42 # seed 고정 42 -> 1113
...
# Reduce
rlr = ReduceLROnPlateau(monitor='val_loss', patience=4, factor=0.333, mode='min')
...
print('가중치 저장')
model.save_weights('../resource/weights/multiresunetatt_w.h5')
print("저장된 가중치 명: multiresunetatt_w.h5")
...
joblib.dump(y_pred_dict, './multiresunetatt_w.pkl')
print("done")