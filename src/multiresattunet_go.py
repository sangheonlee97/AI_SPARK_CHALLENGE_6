...
# Reduce
rlr = ReduceLROnPlateau(monitor='val_loss', patience=2, factor=0.1, mode='min')
...
print('가중치 저장')
model.save_weights('../resource/weights/multiresunetatt_go4.h5')
print("저장된 가중치 명: multiresunetatt_go4.h5")
...
joblib.dump(y_pred_dict, './multiresunetatt_go4.pkl')
print("done")