...
# train : val = 8 : 2 나누기
x_tr, x_test = train_test_split(train_meta, test_size=0.2, random_state=RANDOM_STATE)
x_tr, x_val = train_test_split(x_tr, test_size=0.2, random_state=RANDOM_STATE)
...
images_test = [os.path.join(IMAGES_PATH, image) for image in x_test['train_img'] ]
masks_test = [os.path.join(MASKS_PATH, mask) for mask in x_test['train_mask'] ]

train_generator = generator_from_lists(images_train, masks_train, batch_size=BATCH_SIZE, random_state=RANDOM_STATE, image_mode="762")
validation_generator = generator_from_lists(images_validation, masks_validation, batch_size=BATCH_SIZE, random_state=RANDOM_STATE, image_mode="762")
test_generator = generator_from_lists(images_test, masks_test, batch_size=BATCH_SIZE, random_state=RANDOM_STATE, image_mode="762")
...
# model.load_weights('../resource/dataset/train_output/model_unet_base_line_final_weights.h5')

print("7610 test set miou : ", model.evaluate(test_generator))
# y_pred_dict = {}
